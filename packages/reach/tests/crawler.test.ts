...
describe('SiteCrawler', () => {
  ...
  it('should skip external domains when sameOrigin is true', async () => {
    ...
    expect(result.pages).toEqual(['https://example.com/', 'https://example.com/about']);
  ...
  it('should obey the maxPages option', async () => {
    ...
    expect(result.pages).toEqual(['https://example.com/', 'https://example.com/a']);
    expect(result.errors).toHaveLength(0);
  });
  ...
  it('should treat trailing slash variants as the same page', async () => {
    ...
    expect(result.pages).toEqual(['https://example.com/', 'https://example.com/profile']);
    expect(result.skipped).toBeGreaterThan(0);
  });
});
